#!/usr/bin/env python3
"""
Script per esportare i risultati del test primevul in formato Excel.
Genera un file results.xlsx con i risultati dalla tabella primevul_results_c2v.
"""
...
def export_results_to_excel():
    ...
    print("=" * 80)
    print("📊 ESPORTAZIONE RISULTATI PRIMEVUL")
    print("=" * 80)
    print()
    ...
    try:
        response = supabase.table('primevul_results_c2v').select('*').execute()
    ...
    output_dir = os.path.join(os.path.dirname(__file__), 'Models', GEMINI_MODEL_NAME, 'primevul')
