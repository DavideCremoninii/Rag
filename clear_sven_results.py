#!/usr/bin/env python3
"""
Script per svuotare la tabella sven_results_c2v nel database Supabase.
...
def clear_results_table(supabase_client):
    """
    Svuota la tabella sven_results_c2v.
    ...
    try:
        ...
        try:
            supabase_client.rpc('clear_results_c2v').execute()
            print(f"   ✅ Utilizzata RPC function clear_results_c2v()")
...
def main():
    ...
    # Chiedi conferma
    print("\n⚠️  ATTENZIONE: Questa operazione eliminerà TUTTI i risultati dei test SVEN!")
    print("   Tabella interessata: sven_results_c2v")
